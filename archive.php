    ...
    <section class="pt-8 md:pt-10" id="archive-content">
        <div class="container">
            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <!-- ═══ سایدبار (جستجو و فیلترها) ═══ -->
                <aside class="w-full lg:w-[280px] shrink-0 space-y-6 lg:sticky lg:top-28 self-start">
                    
                    <!-- ویجت جستجو -->
                    <div class="bg-white dark:bg-white/5 rounded-2xl p-5 border border-[var(--border)] shadow-sm">
                        <h3 class="text-[15px] font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                            <i class="ph ph-magnifying-glass text-primary"></i> جستجو در مطالب
                        </h3>
                        <div class="relative">
                            <input type="text" placeholder="کلمه کلیدی..." class="w-full bg-gray-50 dark:bg-black/20 border border-[var(--border)] rounded-xl py-2.5 px-4 text-sm text-gray-800 dark:text-gray-200 focus:outline-none focus:border-primary/50 transition-colors">
                            <button class="absolute left-2 top-1/2 -translate-y-1/2 w-8 h-8 flex items-center justify-center rounded-lg text-gray-400 hover:text-primary transition-colors">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <!-- نوار ابزار بالای گرید و عنوان صفحه -->
                    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6 pb-4 border-b border-[var(--border)]">
                        ...
                        <div class="flex items-center gap-2 bg-white dark:bg-white/5 px-3 py-1.5 rounded-xl border border-[var(--border)]">
                            <span class="text-[13px] text-gray-500">مرتب‌سازی:</span>
